...
global vartest, effets, bruit, val_bruit, fenetre, taille, max_E, effets_Back, no  # À quoi ça sert ?
...
def defvaleur(filtre, val):
    ...
    def sortie():
        global tmp_val
        if tmp_val == 0:  # ne retourne pas de valeur si l'utilisateru choisit 0
            return
        curseur.destroy()
